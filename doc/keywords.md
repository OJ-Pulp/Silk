...
- **Parts:** Components of a **product** or **kit**; will have incoming and outgoing `:REQUIRE` edges.
- **Customers:** The end user that rceives the product; will not have edges related to parts, only edges related to finished products
